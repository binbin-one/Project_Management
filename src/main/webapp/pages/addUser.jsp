...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post"  action="userAction_addUser" enctype="multipart/form-data" onsubmit="return test()">
            <div class="form-group">
                <label name="user.uname">用户名<span id="span1" style="display: none"></span></label>
                <input type="text" class="form-control" name="user.uname" id="username" placeholder="请输入用户名" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="user.upwd">密码<span id="span2" style="display: none"></span></label>
                <input type="password" class="form-control" name="user.upwd" id="password" placeholder="请输入密码" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="user.uphone">电话<span id="span3" style="display: none"></span></label>
                <input type="text" class="form-control" name="user.uphone" id="phone" placeholder="请输入电话" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="user.uemail">邮箱<span id="span4" style="display: none"></span></label>
                <input type="text" class="form-control" name="user.uemail" id="email" placeholder="请输入邮箱" style="width: 300px">
            </div>
            ...
            <label name="uploadImage">用户图像</label>
                <input type="file" name="uploadImage" id="ufile"/>

            <div class="form-group">
                <label name="user.uremark">备注<span id="span5" style="display: none"></span></label>
                <textarea name="user.uremark" id="" cols="30" rows="5" class="form-control input-dark" name="user.uremark" id="uremark" placeholder="请输入备注" style="width: 300px"></textarea>
            </div>
            ...
            <script type="text/javascript">
                ...
                function test(){
                    ...
                    if(!$("#username").val()==""){
                        ...
                        var patt1= /^[0-9a-zA-Z]{4,20}$/;
                        if(!patt1.test(str_name)){
                            alert("用户名格式必须设置4-20位之间！");
                            return false;
                        }
                    }
                    if($("#password").val()==""){
