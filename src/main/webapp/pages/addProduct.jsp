    ...
    <div class="main-content">
        ...
        <form method="post"  action="productAction_addProduct" onsubmit="return test()">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="product.ccode" id="ccode" placeholder="请输入特征码" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="product.cexplain">产品简介<span id="span3" style="display: none"></span></label>
                <input type="text" class="form-control" name="product.cexplain" id="cexplain" placeholder="请输入产品简介" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="product.ccreateuserid">创建人ID<span id="span4" style="display: none"></span></label>
                <input type="text" class="form-control" name="product.ccreateuserid" id="ccreateuserid" placeholder="请输入创建人ID" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="product.dcreatedatetime">创建日期<span id="span6" style="display: none"></span></label>
                <input type="text" class="form-control" name="product.dcreatedatetime" id="dcreatedatetime" placeholder="请输入创建时间" style="width: 300px">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="product.cremark" id="cremark" cols="30" rows="5" class="form-control input-dark" name="customer.cremark" id="cremark" placeholder="请输入备注" style="width: 300px"></textarea>
            </div>
