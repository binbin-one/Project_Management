function Page(opt){
		...
		var clickpages = {
			...
			newPages:function (type, i) {
				...
				var HL = '<li><a>...</a></li>';
				html = '<li><a href="userAction_selectAllUser?pageBean.cpage=1">&laquo;</a></li>\
					<li><a href="userAction_selectAllUser?pageBean.cpage=${pageBean.cpage-1>0?pageBean.cpage-1:1}">上一页</a></li>'
				for (var n = 0;n<3;n++){
				...
				html += '<li><a href="userAction_selectAllUser?pageBean.cpage="+${pageBean.cpage+1>pageBean.allPage?pageBean.allPage:pageBean.cpage+1}">下一页</a></li>\
					<li><a  href="userAction_selectAllUser?pageBean.cpage="+${pageBean.allPage}">&raquo;</a></li>';
