                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="${pageContext.request.contextPath}/image/http_imgload3.jpg" class="img-responsive img-circle" />
                        </a>
                    </div>
                    ...
                    <div class="user-details">
                        ...
                        <h3>
                            <a href="extra-profile.html">${loginUser.uname}</a>

                            <!-- Available statuses: is-online, is-idle, is-busy and is-offline -->
                            <span class="user-status is-online"></span>
                        </h3>

                        <p class="user-title">角色名</p>

                        <div class="user-links">
                            <a href="${pageContext.request.contextPath}/pages/user-registration.jsp" class="btn btn-primary">更改用户信息</a>
                            <a href="${pageContext.request.contextPath}/pages/extra-login.jsp" class="btn btn-success">退出</a>
                        </div>
