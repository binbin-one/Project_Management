...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post"  action="productAction_updateProduct" enctype="multipart/form-data" onsubmit="return test()">
            <s:hidden name="product.cid"/><br/>
            <div class="form-group">
                <label name="product.cname">产品名称<span id="span1" style="display: none"></span></label>
                <s:textfield name="product.cname" class="form-control" id="cname" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="product.ccode">特征码<span id="span2" style="display: none"></span></label>
                <s:textfield name="product.ccode" class="form-control" id="ccode" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="product.cexplain">产品简介<span id="span3" style="display: none"></span></label>
                <s:textfield name="product.cexplain" class="form-control" id="cexplain" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="product.ccreateuserid">创建人ID<span id="span4" style="display: none"></span></label>
                <s:textfield name="product.ccreateuserid" class="form-control" id="ccreateuserid" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="product.dcreatedatetime">创建日期<span id="span6" style="display: none"></span></label>
                <s:textfield name="product.dcreatedatetime" class="form-control" id="dcreatedatetime" style="width: 300px"/><br/>
            </div>
            <label class="control-label" name="product.cstatus" style="color: #979898;">产品状态</label>
            <s:radio list="#{'0':'锁定','1':'正常'}" name="product.cstatus" value="%{'1'}"/><br/>
            <div class="form-group">
                <label name="product.cremark">备注<span id="span8" style="display: none"></span></label>
                <s:textarea name="product.cremark" class="form-control" cols="30" rows="5" id="cremark" style="width: 300px"/><br/>
            </div>
            <button type="submit" class="btn btn-default">更改产品</button>
        </form>
    ...
    <div id="chat" class="fixed">
        ...
        <div class="chat-inner">
            ...
            <script type="text/javascript">
                ...
                function test(){
                    if($("#cname").val()=="") {
                        $("#span1").text('产品名不能为空').css('color','#979898').css('margin-left','260px').css('margin-top','-36px').css('display','block');
                        return false;
                    }
                    if(!$("#cname").val()==""){
                        var str_name = document.getElementById("username").value;
                        var patt1= /^[0-9a-zA-Z]{3,20}$/;
                    ...
                    if($("#ccode").val()==""){
                        $("#span2").text('特征码不能为空').css('color','#979898').css('margin-left','260px').css('margin-top','-36px').css('display','block');
                        return false;
                    }

                    if($("#cexplain").val()==""){
                        $("#span3").text('创建人简介不能为空').css('color','#979898').css('margin-left','260px').css('margin-top','-36px').css('display','block');
                        return false;
                    }

                    if($("#ccreateuserid").val()=="") {
                        $("#span4").text('创建人ID为空').css('color','#979898').css('margin-left','260px').css('margin-top','-36px').css('display','block');
                        return false;
                    }
