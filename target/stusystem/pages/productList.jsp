    ...
    <div class="main-content">
        ...
        <ul class="user-info-menu right-links list-inline list-unstyled">
            <li class="search-form"><!-- You can add "always-visible" to show make the search input visible -->
                ...
                <s:form id="seachFrm" action="productAction_selectAllProduct" method="post">
            ...
            <table class="table">
                ...
                <s:iterator var="obj" value="pageBean.result" status="ids">
                    <tr>
                        ...
                        <td>${obj.ccode}</td><td>${obj.cexplain}</td>
                        <td>${obj.ccreateuserid}</td><td>${obj.dcreatedatetime.toString().substring(0,10)}</td>
                        <td>${obj.cstatus==0?"锁定":"正常"}</td>
                        <td>${obj.cremark}</td>
                        <td><button type="button" class="btn btn-success" onclick="window.location.href='productAction_selectByIdProduct?product.cid=${obj.cid}'">更新</button><br/>
                        <td><button type="button" class="btn btn-danger" onclick="window.location.href='productAction_deleteProduct?product.cid=${obj.cid}'">删除</button><br/>
                    </tr>
                </s:iterator>
                </tbody>
            </table>
    ...
    <%-- 查询所有客户信息 --%>
        <div style="position: relative;margin-top: 20px;float: right">
            ...
            <c:forEach var="i" begin="1" end="${pageBean.allPage }" step="1">
                <input type="button" value="第${i }页" onClick="location.href='productAction_selectAllProduct?pageBean.cpage=${i}'"/>
            </c:forEach>
            <a href="productAction_selectAllProduct?pageBean.cpage=1">首页</a>|
            <a href="productAction_selectAllProduct?pageBean.cpage=${pageBean.cpage-1>0?pageBean.cpage-1:1}">上一页</a>|
            <a href="productAction_selectAllProduct?pageBean.cpage=${pageBean.cpage+1>pageBean.allPage?pageBean.allPage:pageBean.cpage+1}">下一页</a>|
            <a href="productAction_selectAllProduct?pageBean.cpage=${pageBean.allPage}">尾页</a>
            <form action="productAction_selectAllProduct" method="post">
