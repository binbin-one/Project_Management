...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post"  action="itemAction_addItem" onsubmit="return test()">
            <div class="form-group">
                <label name="item.cname">项目名称<span id="span1" style="display: none"></span></label>
                <input type="text" class="form-control" name="item.cname" id="cname" placeholder="请输入项目名称" style="width: 300px">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="item.cexplain" id="cphone2" placeholder="输入项目介绍" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="item.dsalary">金额<span id="span2" style="display: none"></span></label>
                <input type="text" class="form-control" name="item.dsalary" id="cphone" placeholder="请输入金额" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="item.dcreatedatetime">创建日期<span id="span3" style="display: none"></span></label>
                <input type="text" class="form-control" name="item.dcreatedatetime" id="dcreatedatetime" placeholder="请输入创建时间" style="width: 300px">
            </div>
            <label class="control-label" name="item.cusetype" style="color: #979898;">项目类型</label>
            <s:radio list="#{'0':'试用','1':'正式'}" name="item.cusetype" value="%{'1'}"/><br/>
            <label class="control-label" name="item.cpaytype" style="color: #979898;">付款状态</label>
            <s:radio list="#{'0':'未结款','1':'结款中','2':'已结款'}" name="item.cpaytype" value="%{'1'}"/><br/>
            <label class="control-label" name="item.cstatus" style="color: #979898;">项目状态</label>
            <s:radio list="#{'0':'无效','1':'有效'}" name="item.cstatus" value="%{'1'}"/><br/>
            <div class="form-group">
                <label name="item.cremark">备注<span id="span4" style="display: none"></span></label>
                <textarea name="item.cremark" id="cremark" cols="30" rows="5" class="form-control input-dark" name="customer.cremark" id="cremark" placeholder="请输入备注" style="width: 300px"></textarea>
            </div>
            <button type="submit" class="btn btn-default">新增项目</button>
        </form>
