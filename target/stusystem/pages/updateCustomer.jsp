...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post"  action="customerAction_updateCustomer"onsubmit="return test()">
            <s:hidden name="customer.cid"/><br/>
            <div class="form-group">
                <label name="customer.cname">客户名称<span id="span1" style="display: none"></span></label>
                <s:textfield name="customer.cname" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.ctaxcode">客户税号<span id="span2" style="display: none"></span></label>
                <s:textfield name="customer.ctaxcode" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.clinkman">联系人<span id="span3" style="display: none"></span></label>
                <s:textfield name="customer.clinkman" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.cphone">联系电话<span id="span4" style="display: none"></span></label>
                <s:textfield name="customer.cphone" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.caddress">地址<span id="span5" style="display: none"></span></label>
                <s:textfield name="customer.caddress" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.dcreatedatetime">创建日期<span id="span6" style="display: none"></span></label>
                <s:textfield name="customer.dcreatedatetime" class="form-control" style="width: 300px"/><br/>
            </div>
            <label class="control-label" name="customer.cstatus" style="color: #979898;">用户状态</label>
            <s:radio list="#{'0':'锁定','1':'正常'}" name="customer.cstatus"/><br/>
            <div class="form-group">
                <label name="customer.cexplain">说明<span id="span7" style="display: none"></span></label>
                <s:textarea name="customer.cexplain" class="form-control" style="width: 300px"/><br/>
            </div>
            <div class="form-group">
                <label name="customer.cremark">备注<span id="span8" style="display: none"></span></label>
                <s:textarea name="customer.cremark" class="form-control" style="width: 300px"/><br/>
            </div>
            <button type="submit" class="btn btn-default">更改客户</button>
        </form>
