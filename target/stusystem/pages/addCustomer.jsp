...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <form method="post"  action="customerAction_addCustomer" enctype="multipart/form-data" onsubmit="return test()">
            <div class="form-group">
                <label name="customer.cname">客户名称<span id="span1" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.cname" id="cname" placeholder="请输入客户名称" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="customer.ctaxcode">客户税号<span id="span2" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.ctaxcode" id="ctaxcode" placeholder="请输入客户税号" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="customer.clinkman">联系人<span id="span3" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.clinkman" id="clinkman" placeholder="请输入联系人" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="customer.cphone">联系电话<span id="span4" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.cphone" id="cphone" placeholder="请输入电话" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="customer.caddress">地址<span id="span5" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.caddress" id="caddress" placeholder="请输入地址" style="width: 300px">
            </div>
            <div class="form-group">
                <label name="customer.dcreatedatetime">创建日期<span id="span6" style="display: none"></span></label>
                <input type="text" class="form-control" name="customer.dcreatedatetime" id="dcreatedatetime" placeholder="请输入创建时间" style="width: 300px">
            </div>
            <label class="control-label" name="customer.cstatus" style="color: #979898;">用户状态</label>
            <s:radio list="#{'0':'锁定','1':'正常'}" name="customer.cstatus" value="%{'1'}"/><br/>
            <div class="form-group">
                <label name="customer.cexplain">说明<span id="span7" style="display: none"></span></label>
                <textarea name="customer.cexplain" id="cexplain" cols="30" rows="5" class="form-control input-dark" name="customer.cexplain" id="cexplain" placeholder="请输入说明" style="width: 300px"></textarea>
            </div>
            <div class="form-group">
                <label name="customer.cremark">备注<span id="span8" style="display: none"></span></label>
                <textarea name="customer.cremark" id="cremark" cols="30" rows="5" class="form-control input-dark" name="customer.cremark" id="cremark" placeholder="请输入备注" style="width: 300px"></textarea>
            </div>
            <button type="submit" class="btn btn-default">新增客户</button>
        </form>
